...
var refresh = function(){
     $http.get('/accoutUsers').success(function(response){
...
refresh();
    ...
    $scope.addContact = function(){
      console.log($scope.contact);  
        ...
        $http.post('/accoutUsers' , $scope.contact).success(function(response){
 ...
 $scope.remove= function(id){
     ...
     $http.delete('/accoutUsers/'+id).success(function(response){
         refresh();
     });
 };  
...
$scope.edit = function(id){
    console.log(id);
    $http.get('/accoutUsers/'+ id).success(function(response){
...
$scope.update = function(){
    ...
    $http.put('/accoutUsers/' + $scope.contact._id,$scope.contact).success(function(response){
        refresh();
    })
};
