...
var refresh = function(){
     $http.get('/accountUsers').success(function(response){
...
refresh();
    ...
    $scope.addContact = function(){
      console.log($scope.contact);  
        ...
        $http.post('/accountUsers' , $scope.contact).success(function(response){
 ...
 $scope.remove= function(id){
     ...
     $http.delete('/accountUsers/'+id).success(function(response){
         refresh();
     });
 };  
...
$scope.edit = function(id){
    console.log(id);
    $http.get('/accountUsers/'+ id).success(function(response){
...
$scope.update = function(){
    ...
    $http.put('/accountUsers/' + $scope.contact._id,$scope.contact).success(function(response){
        refresh();
    })
};
